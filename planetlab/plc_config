...
PLC_MONITOR_SSL_CRT='/etc/planetlab/monitor_ssl.crt'
...
PLC_MONITOR_DBHOST='localhost'

# Enabled
# Enable on this machine.
PLC_MONITOR_ENABLED=0

# Monitor Email Address
# All messages from Monitor will appear to come from this address.
PLC_MONITOR_FROM_EMAIL='root+monitor@localhost.localdomain'
...
PLC_MONITOR_CC_EMAIL='root+monitor@localhost.localdomain'

# Queue Name in RT for new messages
# All messages from Monitor will be copied to this address.
PLC_MONITOR_RT_QUEUE='support'
...
PLC_MONITOR_DBUSER='monitoruser'
...
PLC_MONITOR_CA_SSL_CRT='/etc/planetlab/monitor_ca_ssl.crt'

# Database Name
# Name of monitor database.
PLC_MONITOR_DBNAME='monitor'
...
PLC_RT_WEB_PASSWORD='password'

# CC Email Address
# All messages to and from PLCRT will be copied to this address.
PLC_RT_CC_ADDRESS='root+cclist@localhost.localdomain'

# Hostname
# The fully qualified hostname.
PLC_RT_HOST='localhost.localdomain'
...
PLC_FLAVOUR_SLICE_PLDISTRO='lxc'
...
PLC_WWW_SSL_KEY='/etc/planetlab/www_ssl.key'
...
# default, this certificate is self-signed. You may replace the
# certificate later with one signed by a root CA.
PLC_WWW_SSL_CRT='/etc/planetlab/www_ssl.crt'
...
# certificate. If your server certificate is self-signed, then this file
# is the same as your server certificate.
PLC_WWW_CA_SSL_CRT='/etc/planetlab/www_ca_ssl.crt'
...
PLC_ROOT_SSH_KEY='/etc/planetlab/root_ssh_key.rsa'

# Root GPG Private Keyring
# The SSH private key used to access the root account on your nodes.
PLC_ROOT_GPG_KEY='/etc/planetlab/secring.gpg'

# Root GPG Public Keyring
# The GPG public keyring used to sign the Boot Manager and all node
# packages.
PLC_ROOT_GPG_KEY_PUB='/etc/planetlab/pubring.gpg'
...
PLC_DEBUG_SSH_KEY_PUB='/etc/planetlab/debug_ssh_key.pub'

# Debug SSH Private Key
# The SSH private key used to access the root account on your nodes when
# they are in Debug mode.
PLC_DEBUG_SSH_KEY='/etc/planetlab/debug_ssh_key.rsa'
...
PLC_ROOT_USER='root@sfa.ict.ac.cn'

# SSL Private Key
# The SSL private key to use for encrypting HTTPS traffic.
PLC_BOOT_SSL_KEY='/etc/planetlab/boot_ssl.key'
...
PLC_BOOT_SSL_PORT=443

# Root CA SSL Public Certificate
# The certificate of the root CA, if any, that signed your server
# certificate. If your server certificate is self-signed, then this file
# is the same as your server certificate.
PLC_BOOT_CA_SSL_CRT='/etc/planetlab/boot_ca_ssl.crt'
...
PLC_MAIL_BOOT_ADDRESS='root+install-msgs@localhost.localdomain'
...
PLC_RATELIMIT_ENABLED='false'

# IP Mask
# The IP Mask that should be applied to incoming packets to match the IP
# Subnet for IPoD packets.
PLC_API_IPOD_MASK='255.255.255.255'

# SSL Private Key
# The SSL private key to use for encrypting HTTPS traffic. If non-
# existent, one will be generated.
PLC_API_SSL_KEY='/etc/planetlab/api_ssl.key'

# Root CA SSL Public Certificate
# The certificate of the root CA, if any, that signed your server
# certificate. If your server certificate is self-signed, then this file
# is the same as your server certificate.
PLC_API_CA_SSL_CRT='/etc/planetlab/api_ca_ssl.crt'
...
# not be changed.
PLC_API_MAINTENANCE_SOURCES='10.24.0.70 127.0.0.1'
...
# by a root CA.
PLC_API_SSL_CRT='/etc/planetlab/api_ssl.crt'
...
# logins.
PLC_API_MAINTENANCE_USER='maint@localhost.localdomain'
...
PLC_API_MAINTENANCE_PASSWORD='5852c125-0a30-4913-803a-667452ccd239'

# Database Name
# The name of the database to access.
PLC_DB_NAME='planetlab5'
...
# will be generated.
PLC_DB_PASSWORD='3dd0996b-ade5-4e4e-90a9-4b973f2dab55'

# Type
# The type of database server. Currently, only postgresql is supported.
PLC_DB_TYPE='postgresql'
...
PLC_NET_DNS2='10.21.2.180'

# Primary DNS Server
# Primary DNS server address.
PLC_NET_DNS1='10.21.2.180'
...
PLC_RESERVATION_GRANULARITY=3600
