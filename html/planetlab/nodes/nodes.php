...
// fetch nodes 
$node_fixed_columns=array('node_type','site_id','boot_state','last_contact','interface_ids','peer_id', 'slice_ids', 'public_ip');
...
$fix_columns[]=array('tagname'=>'public_ip', 'header'=>'PUI', 'type'=>'string', 'title'=>'public ip');
