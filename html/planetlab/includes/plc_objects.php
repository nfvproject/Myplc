...
/////////////////////////////////////////////////////////////test by xiaohui/////////////////////////
class Sliver extends PlcObject {
  var $node_id;
  var $slice_id;
  var $sliver_state;
  var $sliver_port;

  function Sliver($sliverinfo) {
    global $plc, $api, $adm;
    $this->node_id = $sliverinfo['node_id'];
    $this->slice_id = $sliverinfo['slice_id'];
    $this->sliver_state = $sliverinfo['sliver_state'];
    $this->sliver_port = $sliverinfo['sliver_port'];
